<template>
  <v-col class="mb-4">
    <h3 class="display-2 font-weight-bold mb-3">Hosting List</h3>
    <v-table>
      <thead>
        <tr>
          <th>Select</th>
...
import type { IHostingForm } from '@/interfaces/main'
// Raw data
import data from '@/data/hostings'

export default defineComponent({
  name: 'FormHosting',
  mounted(): void {
    this.form = data.map(({ sub_type, power, name, resources }) => {
      return {
